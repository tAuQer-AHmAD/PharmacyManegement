...
<body>
    <div class="mainContainer">
        ...
        <form action="{{ route ('saveUpdatedData', $med->id) }}" method="post">
            @csrf
            <h4>NAME : {{$med->medicine->name}}</h4>
            <h4>CUSTOMER: {{$med->customer->name}}</h4>


            <label for="stock">quantity &nbsp;</label>
            <input type="number" id="stock" name="stock" value="{{$med->quantity}}"><br><br>
