...
<body>
    <div class="mainContainer">
        ...
        <form action="{{ route ('saveUpdatedData', $medicine->id) }}" method="post">
            @csrf
            <label for="name">Name: &nbsp;</label>
            <input type="text" id="name" name="name" value="{{$medicine->name}}"><br><br>

            <label for="cnic">CNIC: &nbsp;</label>
            <input type="text" id="cnic" name="cnic" value="{{$medicine->cnic}}"><br><br>

            <label for="phone">Phone No. &nbsp;</label>
            <input type="text" id="phone" name="phone" value="{{$medicine->phone}}"><br><br>

            <label for="adress">Address &nbsp;</label>
            <input type="text" id="adress" name="adress" value="{{$medicine->adress}}"><br><br>
